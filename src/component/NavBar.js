        ...
        <ul className="header-right justify-content-end d-flex align-items-center mb-0">
          ...
          <li>
            <div className="dropdown morphing scale-left notifications">
              ...
              >
                <span className="d-none d-xl-block me-2">
                  Notification
                </span>
                <svg
          ...
          <li className="d-none d-lg-inline-block">
            <div className="dropdown morphing scale-left grid-menu">
              ...
              >
                <div className="card">
                  <div
                    className="row g-1 text-center p-3"
                    style={{ width: 302 }}
                  >
                    <div className="col-6">
                      <a
          ...
          {/* start: quick light dark */}
          <li>
            <a className="nav-link quick-light-dark" href="#">
              <svg
                viewBox="0 0 16 16"
                width="18px"
                fill="currentColor"
